 ...
 *
 * This component replaces UpgradePrompt when running on native iOS.
 * It uses iapService.js (cordova-plugin-purchase / StoreKit) instead of Stripe.
...
export default function IOSUpgradePrompt({ isOpen, onClose, onSuccess }) {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      // The approved handler in iapService will update Supabase.
      // We call onSuccess so the parent can refresh the profile.
